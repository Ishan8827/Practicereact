...
function Sortedd(){
    ...
    useEffect(()=>fetch("https://www.justwravel.com/otherPages/month_trip_api/February/all").then((res)=>res.json()).then((response)=>setstate(response.data.sort((a,b)=>a.numofdays-b.numofdays))))
